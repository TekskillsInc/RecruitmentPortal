...
<section id='content'>
	...
	<div class="dataTables_wrapper" style="margin-bottom: 3em;">
														...
														<table
															...
															<tbody>
																...
																,'${candidateInfo.resn_reloc}')"><font
																			color=blue>${candidateInfo.first_name}</font></a></td>
																</tr>
																<tr>
																	<th
																	...
																	<td><a data-toggle='modal'
																		...
																		onclick="candidatefeedback_View('${candidateInfo.candidateid}','${candidateInfo.contact_number}','${candidateInfo.first_name}')"><font
		...
		<div class='row-fluid' id='content-wrapper'>
					...
					<div class='row-fluid' style="margin-top: -65px;">
						<div class='span12 box'>
							<div class='box-header orange-background'
								style="line-height: 5px;">
								<div class="title-head">
									<Strong style="color: #000080; padding-left: 42%;">Employment
										Details</Strong>
												...
												<div class='scrollable-area'
													...
													<table
														...
														<tbody>
															...
															<tr>
																<td>${candidateInfo.prev_org}/${candidateInfo.current_org}</td>
																<td>${candidateInfo.doj_cur_org}</td>
																<td>${candidateInfo.currentCTC}&${candidateInfo.doj_cur_org}</td>
			...
			<div class='modal hide fade' id='modal-addeducationdetails' tabindex='-1' style="height: 70% !important;">
		...
		<div class='modal-body' id="jd_assignedto">
			...
			<form class='form form-horizontal validate-form'
				style='margin-bottom: 0;' action="addeducationdetails"
				method="GET">
				...
				<div class="form-group">
					<div class='control-group'>
						...
						<div class='controls'>
							<input type="text" 
							name="ssc" value="${candEducainfo.ssc}"	class="form-control" title="only numbers,characters, dot and %"
					...
					<div class='control-group'>
						...
						<div class='controls'>
							<input type="text" id="intermediate" name="intermediate" value="${candEducainfo.intermediate}"
				...
				<div class='control-group'>
						...
						<div class='controls'>
							<input type="text" id="graduation"	name="graduation" value="${candEducainfo.graduation}"
				...
				<div class='control-group'>
						...
						<div class='controls'>
							<input type="text" id="post_graduation"	name="post_graduation" value="${candEducainfo.post_graduation}"
							class="form-control" title="only numbers,characters, dot and %" pattern="^([A-Za-z0-9%.,]+ )+[A-Za-z0-9%.,]+$|^[A-Za-z0-9%.,]+$"/>
						</div>
					</div>
					<div class='control-group'>
						...
						<div class='controls'>
							<input type="text" id="educomments"
							name="educomments" value="${candEducainfo.comments}"
							class="form-control" />
						</div><center><span><font color=red>Only accept numbers,alphabets, %, dot comma<br>	Extra spaces will not accept</font></span></center>
					</div>
			...
			<c:choose>
												...
												<div class='box-content'>
													<div class='control-group'>
														<div class='controls'>
															...
															<a  data-toggle='modal'
																onclick="preupload('${candidateInfo.candidateid}','${candidateInfo.contact_number}','${bdname}','${recname}','${clientname}','${jobid}')"
																href='#modal-example3'><strong><i class="icon-upload btn btn-info btn-sm" >upload</i></strong> </a>
				...
				<c:when test="${role=='NEGOTIATOR' || role=='HRUSER' || role=='HRMANAGER'}">
					<center>
						<div class='container-fluid'>
							<div class='row-fluid' id='content-wrapper'>
								<div class='span12'>
													...
													<div class='control-group'>
														<div class='controls'>
															...
															<a class='btn btn-default btn-xs' data-toggle='modal'
																href='#modal-viewDocs'
																onclick="viewDocuments('${candidateInfo.candidateid}','${bdname}','${recname}','${clientname}','${jobid}')">
				...
				<div class='row-fluid' style="margin-top: -10px;">
					<div class='span12 box'>
						<div class='box-header orange-background'
							style="line-height: 5px;">
							<div class="title-head">
								<Strong style="color: #000080; padding-left: 42%;">Personal
									Details 
									<c:choose>
										<c:when test="${role=='RECRUITER' || role=='TEAMLEAD'}">
	...
	<tr>
																	<th
																		...
																		location</th>
																	<td><p
																			style="white-space: pre-wrap; word-wrap: break-word; width: 300px;">${candidateInfo.workLocation}</p></td>
																</tr>
													...
													<div style="height: 160px;">
														...
														<table
															...
															<tbody>
																...
																<tr>
																	<th
																		style='text-align: center; color: #191970; vertical-align: middle;'>Family Additional Info</th>
																	<td><p
																			style="white-space: pre-wrap; word-wrap: break-word; width: 300px;">${candiaddtnlinfo.familyDetails}</p></td>
																</tr>
																</tbody>
														</table>
													</div>
		...
		<div class='modal hide fade' id='modal-negotiationteametails'
			tabindex='-1' style="height: 90% !important;">
			<div class='modal-header' style="max-width: 980px; overflow-y: auto;">
				<button class='close' data-dismiss='modal' type='button'>&times;</button>
				<h3>Candidate Expectations Details</h3>
			</div>
			...
			<div class='modal-body' id="jd_assignedto">
				...
				<form class='form form-horizontal validate-form'
					...
					<div class='control-group'>
						<label class='control-label' for='validation_jd_status'
							style="color: #191970;"><span style="color: red;"></span>Current CTC PM: </label>
						<div class='controls'>
							<input type="text" id="nego_ctc_pm"
								name="nego_ctc_pm" value="${candiaddtnlinfo.nego_ctc_pm}"
								class="form-control" title="only numbers,characters and dot" pattern="^([A-Za-z0-9.]+ )+[A-Za-z0-9.]+$|^[A-Za-z0-9.]+$" />
						</div>
					</div>
					<div class='control-group'>
						<label class='control-label' for='validation_jd_status'
							style="color: #191970;"><span style="color: red;"></span>Current CTC PA: </label>
						<div class='controls'>
							<input type="text" id="nego_ctc_pa"
								name="nego_ctc_pa" value="${candiaddtnlinfo.nego_ctc_pa}"
								class="form-control" title="only numbers,characters and dot" pattern="^([A-Za-z0-9.]+ )+[A-Za-z0-9.]+$|^[A-Za-z0-9.]+$"/>
						</div>
					</div>
					...
					<div class='control-group'>
						<label class='control-label' for='validation_jd_status'
							style="color: #191970;"><span style="color: red;"></span>Expected CTC PM: </label>
						<div class='controls'>
							<input type="text" id="nego_ectc_pm"
								name="nego_ectc_pm" value="${candiaddtnlinfo.nego_ectc_pm}"
								class="form-control" title="only numbers,characters and dot" pattern="^([A-Za-z0-9.]+ )+[A-Za-z0-9.]+$|^[A-Za-z0-9.]+$"/>
						</div>
					</div>
					<div class='control-group'>
						<label class='control-label' for='validation_jd_status'
							style="color: #191970;"><span style="color: red;"></span>Expected CTC PA: </label>
						<div class='controls'>
							<input type="text" id="nego_ectc_pa"
								name="nego_ectc_pa" value="${candiaddtnlinfo.nego_ectc_pa}"
								class="form-control" title="only numbers,characters and dot" pattern="^([A-Za-z0-9.]+ )+[A-Za-z0-9.]+$|^[A-Za-z0-9.]+$"/>
						</div>
					</div>
					<div class='control-group'>
						...
						<div class='controls'>
							<input type="text" id="nego_rate_pm"
						...
						<div class='controls'>
							 <input type="text" id="nego_rate_pa"
					...
					<div class='span12 box'>
						<div class='box-header orange-background'
							...
							<div class="title-head">
								...
								<c:choose>
									<c:when test="${role=='NEGOTIATOR'}">
										<a data-toggle='modal' href='#modal-negotiationteametails'>
											<i class="icon-plus"></i>
										</a>
									</c:when>
								</c:choose>
													...
													<tbody>
														<tr>
															...
															<td
																...
																<c:choose><c:when test="${role=='NEGOTIATOR'}">
															<td style='text-align: center; color: #191970; vertical-align: middle;'>${candiaddtnlinfo.nego_ctc_pa}</td>
															<td style='text-align: center; color: #191970; vertical-align: middle;'>${candiaddtnlinfo.nego_ctc_pm}</td>
																</c:when></c:choose>
														</tr>
														<tr>
															<th
															...
															<td
																...
																<c:choose><c:when test="${role=='NEGOTIATOR'}">
															<td
																style='text-align: center; color: #191970; vertical-align: middle;'>${candiaddtnlinfo.nego_ectc_pa}</td>
															<td
																style='text-align: center; color: #191970; vertical-align: middle;'>${candiaddtnlinfo.nego_ectc_pm}</td>
																</c:when></c:choose>
														</tr>
														<tr>
															<th
													...
													<div class='scrollable-area'
														...
														<table
															...
															<tbody>
																<tr>
																	<th
																		style='text-align: center; color: #191970; vertical-align: middle;'>Approved
																		CTC</th>
																	<td
																...
																<%-- <tr>
																	<th
																		style='text-align: center; color: #191970; vertical-align: middle;'>Negotiated
																		CTC (Offered CTC)</th>
																	<td
																		style='text-align: center; color: #191970; vertical-align: middle;'>${candiaddtnlinfo.offeredctcPA}</td>
																	<td
																		style='text-align: center; color: #191970; vertical-align: middle;'>${candiaddtnlinfo.offeredctcPM}</td>
																</tr> --%>
																<%-- <tr>
																	<th
																	...
																	<td
																		...
																		${candiaddtnlinfo.mgmtComments}</td>
																	<td
																		style='text-align: center; color: #191970; vertical-align: middle;'></td>
																</tr> 
																<tr>
																	...
																	<td
																		style='text-align: center; color: #191970; vertical-align: middle;'>${candiaddtnlinfo.addtnlbenifits}</td>
																	<td
																		style='text-align: center; color: #191970; vertical-align: middle;'></td>
																</tr>--%>
															</tbody>
			...
			<div class='row-fluid' style="margin-top: -70px;">
				<div class='span12 box'>
					<div class='box-header orange-background' style="line-height: 5px;">
						<div class='title'>
							<p>
								<Strong style="color: #000080;">Negotiation Team
									Comments</Strong>
							</p>
						</div>
					</div>
												...
												<thead>
													<tr>
														...
														<th
															style='text-align: center; color: #191970; vertical-align: middle;'>Comments</th>
														<!-- <th
															style='text-align: center; color: #191970; vertical-align: middle;'>Status</th>
														<th
															style='text-align: center; color: #191970; vertical-align: middle;'>File
															Name</th> -->
														<th
												...
												<tbody>
													<c:forEach var="viewcom" items="${viewcomObj}">
														<tr>
															...
															<%-- <td><p
																	style="white-space: pre-wrap; word-wrap: break-word;">${viewcom.negStatus}</p></td>
															<td><a
																href="downloadNegMailApprove?filename=${viewcom.filename}&canid=${canid}"><font
																	color=blue>${viewcom.filename}</font></a></td> --%>
...
<div class='modal hide fade' id='modal-addcanAdddetails' tabindex='-1'
				...
				<div class="form-group">
					...
					<div class='control-group'>
						...
						<div class='controls'>
							...
							value="${candiaddtnlinfo.mothername}" class="form-control"
							title="only accepts characters" pattern="[a-zA-Z][a-zA-Z\s]*"></textarea>
						</div>
					</div>
 	...
 	<div class='modal hide fade' id='modal-example4' tabindex='-1'
		style="height: 50% !important; overflow-y: auto;">
		<div class='modal-header' style="max-width: 980px; overflow-y: auto;">
						  ...
						  <input type="hidden"	name="recname" value="${recname}">
						   <input type="hidden" name="jobid" value="${jobid}">
						    ...
						    <input type="hidden" name="candidatename" value="${candidateInfo.first_name}">
								...
								<div class='control-group'>
									<label class='control-label' for='validation_jd_status'
										style="color: #191970;"><span style="color: red;"></span>Release
										Status : </label>
										<c:choose>
										<c:when test="${canStatus.hr_loi_status=='Released'}">
										<div class='controls'>
										<select name="loistatus" id="loistatus"
								...
								<div class='control-group'>
									...
									<div class='controls'>
										...
										<a href='preObtFiledownload?candidateid=${candidateInfo.candidateid}&&filename=${canStatus.hr_loi_filename}&&fileType=LOI'>${canStatus.hr_loi_filename}</a>
										</c:if>	
							...
							<form class="form-horizontal" style="margin-bottom: 0;"
								...
								<div class='control-group'>
									...
									<div class='controls'>
										...
										<br><span style="color: red;">accept .zip files only and max file size 30MB</span>
									</div>
								</div>
								<div class='control-group'>
									<label class='control-label' for='validation_jd_status'
									...
									<div class='controls'>
									    <input type="hidden" id="Idproof" name="Idproof"  value="IdProof" >
										<input type="file" id="IdProofDocs" name="IdProofDocs" class="form-control" onchange="checkIdDoc(this)" accept=".zip"/><br>
										<span style="color: red;">accept .zip files only and max file size 10MB</span>
									</div>
								</div>
								...
								<div class='control-group'>
									...
									<div class='controls'>
										...
										<span style="color: red;">accept .zip files only and max file size 30MB</span>
									</div>
								</div>
								<div class='control-group'>
									<label class='control-label' for='validation_jd_status'
										style="color: #191970;">Pending Docs : </label>
									<div class='controls'>
										<input type="hidden" id="pendingDoc" name="pendingDoc"  value="Pending Docs" >
										<input type="file" id="pendingDocs" name="pendingDocs" class="form-control" onchange="checkDoc(this)" accept=".zip"/><br>
										<span style="color: red;">accept .zip files only and max file size 30MB</span>
									</div>
								</div>
								<div class='control-group'>
								...
								<%-- <center><div class="form-group">
									<label><strong><b>Add New Docs</b> &nbsp&nbsp&nbsp<button class="btn btn-success" type="button"
											onclick="adddocs();">+</button></strong></label> 
										<div id="adddocs"></div>
								</div></center> --%>
	...
	<div class='modal hide fade' id='modal-viewDocs' tabindex='-1' style="width:70%!important;height:91%!important;left:40%;">
		...
		<%-- 	<c:choose><c:when test="${role=='HRUSER'}">
			<a href='preObtFiledownloadAll?candidateid=${candidateInfo.candidateid}&&candname=${candidateInfo.first_name}&&candphone=${candidateInfo.contact_number}'>DownloadAll Docs</a>
			</c:when>
			</c:choose> --%>
		...
		<div class='modal-body' id="jd_assignedto">
			...
			<form class='form form-horizontal validate-form'
				...
				<div class='control-group'>
						...
						<div class='controls'>
							<input type="text" id="mgmtAppctcPA"
							name="mgmtAppctcPA" value="${candiaddtnlinfo.mgmtAppctcPA}"
							class="form-control" title="only numbers,characters and dot" pattern="^([A-Za-z0-9.]+ )+[A-Za-z0-9.]+$|^[A-Za-z0-9.]+$"/>
						</div>
					</div>
					...
					<div class='control-group'>
						...
						<div class='controls'>
							<input type="text" id="mgmtAppctcPM"
							name="mgmtAppctcPM" value="${candiaddtnlinfo.mgmtAppctcPM}"
							class="form-control" title="only numbers,characters and dot" pattern="^([A-Za-z0-9.]+ )+[A-Za-z0-9.]+$|^[A-Za-z0-9.]+$"/>
						</div>
					</div>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<center>
			<form action="negotiationTeamStatus" enctype='multipart/form-data'
									method="POST">
									<input type="hidden" id="canid" name="canid"
										value="${candidateInfo.candidateid}" /> <input type="hidden"
										id="jobid_ras" name="jobid" value="${jobid}" /> <input
									...
									<input type="hidden" id="bdname" name="bdname"
										...
										<div class='form-group'>											
											<b>Status</b>&nbsp;&nbsp;<select required id="statusid"
												name='statusid' onchange="getStatusId()"
												style="width: 200px; height: 35px;"
												class="form-control text-center">
												<c:choose>
											  <c:when test="${canStatus.nego_status==''}"> 
												<option value="">-- Select Status --</option>
												<option value="Negotiation Pending">Negotiation Pending</option>
												<option value="Negotiation InProgress">Negotiation InProgress</option>
												<option value="Negotiation Completed">Negotiation Completed</option>
												<option value="Negotiation Rejected">Negotiation Rejected</option>
												<option value="Approved By Management">Approved By Management</option>
												</c:when>
												<c:otherwise>
												<option value="${canStatus.nego_status}">${canStatus.nego_status}</option>
												<option value="">-- Select Status --</option>
												<option value="Negotiation Pending">Negotiation Pending</option>
												<option value="Negotiation InProgress">Negotiation InProgress</option>
												<option value="Negotiation Completed">Negotiation Completed</option>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12">
			<div class="status-clint" style="margin-top: -5%;padding-right: 0%;">
			<center>
			<form class='form form-horizontal validate-form' style='margin-bottom: 0;' action="docPageSubmit" method="post" enctype="multipart/form-data">
	       ...
	       <div class="form-group">
					<!-- <label for="inputPassword" class="col-lg-2 control-label"><b>Status</b> </label> -->
					<div class="col-lg-8">
						<b>Status</b>&nbsp;&nbsp;<select name="status" id="status" autoComplete="off"
							class="form-control text-center" onchange="statusByApproved()"
							required>
							<option value="${canStatus.doc_verify_status}">${canStatus.doc_verify_status}</option>
							<option value="">--Select Status--</option>
							<!--<option value="Approved by management">Approved by management</option>-->
				...
				<center><div class="form-group" id=details style="display:none;">
					<!-- <label for="inputPassword" class="col-lg-2 control-label"> -->
					<div class="col-lg-2" id="choose-fle">
					...
					<div class="col-lg-2">
						<center>
							&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
							     ...
							     <c:choose>
								<c:when test="${dcstatus.size()>0 && fn:contains(dcstatus,'Approved')}">
								<input type="submit" style="background: #0b3c7c" class="btn btn-success btn-xs" value="Save Status">
								</c:when>
								<c:otherwise>
								<span data-toggle="tooltip" title="You can't change the status until all documents get approved">
								<input type="submit" style="background: #0b3c7c" class="btn btn-success btn-xs" value="Save Status" disabled>
								</span>
								</c:otherwise>
								</c:choose>
							   <input type="button" style="background: #0b3c7c" class="btn btn-success btn-xs" onclick="goBack()" value="Back"> 
	...
	<c:choose>
	<c:when test="${role=='HRMANAGER'}">
	 <div class="status-clint" style="margin-top: -7%;padding-right: 0%;">
		<div class="form-group" id="btn-custm">
					<div class="col-lg-2"> 
						<center>
...
<script>
	function getStatusId() {
		...
		$.ajax({
			type : "get",
			url : "getDocStatusByCanId?candidateid="+canid,
			cache : false,
			async : false,
			success : function(response) {
				if(response=='success'){
...
<script type="text/javascript">
	...
	function addEmp() {
		...
		divtest.innerHTML = '<div class="form-group"><div><input type="text" class="form-control" id="prevOrgName" name="prevOrgName[]" placeholder="Enter Name" required><input type="file"  id="prevOrgDocs" name="prevOrgDocs[]" class="form-control"  onchange="checkCareerDoc(this)" required accept=".zip"/><button class="btn btn-danger" type="button" onclick="remove_empsC('+ evalue+ ');">-</button></div><br><span style="color: red;">accept .zip files only and max file size 10MB</span></div><br><div class="clear"></div>';
			...
			success : function(response) {
				...
				for (var i = 0; i < list1.length; i++) {
					var tr = "<tr><td>" + list1[i].fileType + "</td>"
							...
							+ list1[i].status + "</td>"
							+ "<td><input type='button'  value='Delete' style='background: #0b3c7c' class='btn btn-success btn-xs' onclick=deleteFile('"+candidateid+"','"+list1[i].tbl_pk+"')></button></td>" + "<td></tr>";
...
function checkDoc(file){
	...
	var filename = file.files[0].name;
 	...
 	if (filename.endsWith(".zip") && FileSize < 30) {
		...
		alert("accept .zip files only and max file size 30 MB");
		$(file).val('');
	}
}
function checkCareerDoc(file){
	...
	if (filename.endsWith(".zip") && FileSize < 10) {
		...
		alert("accept .zip files only and max file size 10 MB");
		$(file).val('');
	}
}
...
<script type="text/javascript">
	function viewDocuments(candidateid, bdname, recname, clientname, jobid) {
		$.ajax({
			type : "get",
				...
				for (var i = 0; i < list1.length; i++) {
					...
					+"<td style='display:none;'><input type='hidden'  name='candidate_ver'   id='candidate_ver'  value="+candidateid+"></td>"
					 ...
					 +"<td style='display:none;'><input type='hidden' name='jobid_ver'      id='jobid_ver'      value="+jobid+"></td>" 
							...
							+"<td><select id='status_ver" + list1[i].tbl_pk + "' size='1'><option value="+list1[i].status+">"+list1[i].status+"</option><option value='Approved'>Approved</option><option value='Rejected'>Rejected</option><option value='onHold'>onHold</option></select></td>"
							+"<td><input type='textarea' rows='4' column='30' id='comments_ver" +  list1[i].tbl_pk + "' value='"+comments+"' name='comments'></td>"
...
function addPersonnelDetails(candidateid){
	alert(candidateid);
	var fathername=$('#fathernametxt').val();
	var mother=$('#mothernametxt').val();
	var familydetails=$('#familydtailsTxt').val();
	var dataobj={father:fathername,
			mother:mother,
			familyDetails:familydetails}; 
	$.ajax({
		type : "post",
		url : "saveCandidatePersonnelInfo?candidateid=" + candidateid ,
		cache : false,
		async : false,
