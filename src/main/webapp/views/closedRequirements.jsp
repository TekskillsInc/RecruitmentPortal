                    ...
                    <div class='span12'>
						...
						<div class="col-md-12">
								<div class="card">
									<div class="row">
										<div class="span12">
											<div class="well bs-component" style="position: relative;height:60px;">

												<form action="seacrhclosedRequirements" method=get>
													<div class="span3">
												...
												<div class="span3">
													...
													<!-- <div style='margin-bottom: 0'> -->
														<button class="btn btn-success btn-xs"
															style="background: #0b3c7c;margin-top: 22px;"
                                    ...
                                    <table id="sampletable"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <!-- <th style='text-align: center;color:#000080;'>Job Received Time</th> -->
                                                <th style='text-align: center;color:#000080;'>Internal/External</th>
                                              <!--   <th style='text-align: center;color:#000080;'>Job close Date</th> -->
                                                ...
                                                <th style='text-align: center;color:#000080;'>TechPanel result</th>
                                        ...
                                        <tbody>
                                            <c:forEach var="job" items="${jobList}">
                                                ...
                                                ${fn:substring(job.jobCode, 0, 20)}..</a></td>
                                                    ...
                                                    <td>${job.account}</td>
                                                    <td>${job.segment}</td>
                                                   <td><a class='btn btn-default btn-xs' data-toggle='modal' href='#modal-TPAvailability' onclick="TP_Availability('${job.jobDescId}')"><i class='icon-calendar' style='color:blue;'></i></a></td>
                                                    <td><a class='btn btn-default btn-xs'
														data-toggle='modal' href='#modal-JDsprofiles' 
														onclick="viewprofileTPScheduled('${job.jobDescId}')">
								...
								<div class='controls'>
                                    ...
                                    <div class='modal hide fade' id='modal-editJD' 
                                        ...
                                        <%--  <div class='control-group'>
                                            ...
                                            <div class='controls'>
                                            <span id="assignTolabel" style="color:green;"></span>
                                                <select class="form-control" data-rule-required='true'
                                       ...
                                       <!--  </div> -->
                                        ...
                                        <div class='form-actions' style='margin-bottom: 0' id="updateDiv">
                                           <input type="submit" class="btn btn-success btn-xs" style="background:#0b3c7c" id="updateAssaignee">
 ...
 function getData(jobval,jobid){
    $.ajax({
        ...
        error: function(){  
           ...
           {
        		window.open("view_Profiles_JD?jobId="+jobdescid+"&&clientName="+clientName+"&&jobCode="+jobcode);
...
<script type="text/javascript">
	function doActionEdit(jobid, jobCode,cmpnyname) {
		$.ajax({
			...
			async : false,
			success : function(response) {
//alert("jobid---"+jobid+"--jobCode--"+jobCode);
				if (response.length != 0) {
					$('#assignToedit').empty();
					$("#jobIdEdit").val(jobid);
