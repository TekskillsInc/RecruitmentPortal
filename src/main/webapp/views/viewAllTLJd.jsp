		...
		<div class='row-fluid' id='content-wrapper'
			...
			<div class='span12'>
					...
					<div class='span12 box bordered-box orange-border'
	                    ...
	                    <div class='box-header orange-background'
							...
							<div class='title' style="line: width:50px;">
								...
								<center><Strong style="color: #000080; font-size: 25px;">View All TL Requirements</Strong></center>
							</div>
				...
				<div class="col-md-12">
					...
					<form action="searreqsbymanager" method="GET" onsubmit="return checkForm(this);">
						<fieldset>		
							           
							             <div class='col-lg-4' >
							             <input type="date" id="fromdate" name='fromdate' class="form-control text-center" 
							              required> 
													
											<input type="date" id="todate" name='todate' class="form-control text-center"
											 required> 
						...
						<div class='box-content box-no-padding'>
							<div class='responsive-table'>
								...
								<th style='text-align: center; color: #000080;'>TL Name</th>
											...
											<tbody>
												...
												<td>${jdlist.jobDescId}</td>
													...
													<td>${jdlist.tlName}</td> 
														...
														<c:if test="${empty jdlist.tlName}"><td>N/A</td></c:if>
														<c:if test="${jdlist.tlName == 200698}"><td>Naveen</td></c:if>
														<c:if test="${jdlist.tlName == 201344}"><td>Virajitha</td></c:if>
														<c:if test="${jdlist.tlName == 201117}"><td>Lavanya</td></c:if>
														<c:if test="${jdlist.tlName == 200360}"><td>Patil</td></c:if>
													...
													<td><a class='btn btn-default btn-xs'
															data-toggle='modal'
															onclick="viewAllprofileManager('${jdlist.jobDescId}','${jdlist.bdName}','${jdlist.jobCode}','${jdlist.client}')">
...
<script type="text/javascript">
												...
												<script>
												/* function viewprofile(jobdescid){
													 alert(jobdescid)
                                                   
													} */
                                                function viewAllprofileManager(jobdescid,bdname,jobCode,cmpny_name)
                                                {
                                                	window.open("viewAllTLSourceProfile?jobId="+jobdescid);
