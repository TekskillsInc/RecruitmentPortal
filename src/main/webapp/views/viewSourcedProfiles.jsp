	...
	<div class='container-fluid'>
		<div class='row-fluid' id='content-wrapper' style="margin-top:-220px;">
					...
					<div class='title' style="line:width:50px;">
						...
						<Strong style="color:#000080;font-size:25px;">View Source Profile</Strong>
					</div>
									...
									<table class='data-table table table-bordered table-striped'
										...
										<thead>
											<tr>
												...
												<th style='text-align: center; vertical-align: middle;color:#000080;'>Name</th>
												<th style='text-align: center; vertical-align: middle;color:#000080;'>Number/
													Alt Number</th>
												<th style='text-align: center; vertical-align: middle;color:#000080;'>Candidate Details</th>
												<th style='text-align: center; vertical-align: middle;color:#000080;'>Recruiter
													Name</th>
													<th style='text-align: center; vertical-align: middle;color:#000080;'>Schedule interview
													</th>
													
													<th style='text-align: center; vertical-align: middle;color:#000080;'>Edit
													Profile</th>
												<th style='text-align: center; vertical-align: middle;color:#000080;'>%</th>
												<th style='text-align: center; vertical-align: middle;color:#000080;'>Resume
													Download</th>
													<th style='text-align: center; vertical-align: middle;color:#000080;'>
													TL Rejected Comments</th>
												<th style='text-align: center; vertical-align: middle;color:#000080;'>TP Interview Status
													</th>
												<th style='text-align: center; vertical-align: middle;color:#000080;'>Client Interview Status
													</th>
													<th style='text-align: center; vertical-align: middle;color:#000080;'>
													SCT Status</th>
													<th style='text-align: center; vertical-align: middle;color:#000080;'>
													...
													<th style='text-align: center; vertical-align: middle;color:#000080;'>
													Send Mail To Candidate</th>
													<th style='text-align: center; vertical-align: middle;color:#000080;'>
													Upload</th>
													<th style='text-align: center; vertical-align: middle;color:#000080;'>Candidate Emailid</th>
										...
										<tbody>
											<c:forEach var="candidate" items="${candidateinfolist}">
												<tr>
													...
													<td>
														<div class='text-center'>
															<a class='btn btn-default btn-small' data-toggle='modal'
																href='#modal-status'
																onclick="doActionstatus('${candidate.candidateInfo.candidateid}',
																'${candidate.candidateInfo.first_name}','${jobId}',
																'${candidate.candidateStatusObj.tlrejectedcomments}')">
													...
													<td><div class='text-right'>
															...
															<a class='btn btn-default btn-xs' data-toggle='modal'
																...
																href='#modal-candidateDetails'>  <i class='icon-user' style="color:Orange;" ></i>
															</a>
														</div></td>
														<!-- </div></td> -->
												 	...
												 	<td><div class='text-right'>
															<a class='btn btn-default btn-xs' data-toggle='modal'
																onclick="scheduleInterview('${candidate.candidateInfo.candidateid}','${jobId}','${jobCode}',
																'${candidate.candidateInfo.first_name}','${candidate.empl_lead}','${candidate.sourcedBy}','${comapany}',
														...
														<div class='text-right'>
															<a class='btn btn-default btn-xs' data-toggle='modal'
																onclick="editProfile('${candidate.candidateInfo.candidateid}','${jobId}','${jobCode}','${candidate.candidateStatusObj.recEmpNo}','${company}','${bdName}')"
																href='#modal-EditProfiles'> <i class='icon-edit' style='color:green'></i>
															</a>
														</div>
													</td>
													...
													<td>
														<div class='text-center'>
															<a class='btn btn-default btn-small' data-toggle='modal'
																...
																<i class='icon-info' style='color:purple'></i>
															</a>
														</div>
													...
													<td><c:choose>
															...
															<c:otherwise>
																  ...
																  <a
																	href="${pageContext.request.contextPath}/download/${candidate.candidateInfo.candidateid}.html"><i class="icon-file"></i></a>
															</c:otherwise>
														</c:choose></td>
												...
												<c:choose> 
												    <c:when test='${empty candidate.interevieDetails.interviewstatus}'>
													<td style="color:Black;"><b>N/A</b></td>
													</c:when>
													<c:when test='${candidate.interevieDetails.interviewstatus=="Scheduled"}'>
													...
													<td style="color:red;"><b>${candidate.interevieDetails.interviewstatus}</b></td>
												     ...
												     <c:choose> 
												    <c:when test='${empty candidate.interevieDetails.clientinterview}'>
													<td style="color:Black;"><b>N/A</b></td>
													</c:when>
												   <c:when test='${candidate.interevieDetails.clientinterview=="Scheduled"}'>
													...
													<c:choose>
													<c:when test='${empty candidate.candidateStatusObj.clientStatus}'>
													<td style="color:Black;"><b>N/A</b></td>
													</c:when>
													 <c:when test='${candidate.candidateStatusObj.clientStatus=="Selected"}'>
													...
													<td><button id="canmail" onclick="sendMailToCandidate('${candidate.candidateInfo.candidateid}','${jobId}')" style="color:blue">send</button> </td>
												
												<td><a class='btn btn-default btn-xs' data-toggle='modal'
																onclick="uploadFile('${candidate.candidateInfo.candidateid}','${jobId}','${jobCode}','${comapany}')"
																href='#modal-example3'><strong>Document
																	Upload</strong> </a></td>
																	<td>${candidate.candidateInfo.emailID}</td>
              ...
              <div class='modal-body'>
                     <div class='row'>
                                  ...
                                  <div class='box'>
                                         <div class='box-padding'>
                                                <form class="form-horizontal" style="margin-bottom: 0;"
                                                       ...
                                                       <input type="hidden" id="candid" name="candid"> <input
                                                              type="hidden" id="candmobno" name="candmobno"> <input
                                                              type="hidden" id="bdname_ds" name="bdname"> <input
                                                              type="hidden" id="recname_ds" name="recname"> <input
                                                              type="hidden" id="clientname_ds" name="clientname"> <input
                                                              type="hidden" id="jobid_ds" name="jobid" value="${jobId}">
                                                        <input type="hidden" id="upjobcode" name="jobcode"  value="${jobCode}">
                                                        <input type="hidden" id="upcmpny" name="cmpny" value="${comapany}">
                                                       
                                                       <center><div class="form-group">
                                                              <label><strong><b>Add New Docs</b> &nbsp&nbsp&nbsp<button class="btn btn-success" type="button"
                                                                            onclick="adddocuments();">+</button></strong></label> 
                                                                     
                                                                     <div id="adddocuments"></div>
                                                       </div></center>
                                                       <center><div class="form-group" id="submitid" style="display: none;">
                           ...
                           <br><br>             
									...
									<div class='modal hide fade' id='modal-status' role='dialog'
										...
										<div class='modal-body'>
											<table class='table table-bordered table-striped'
												...
												<thead>
													<tr>
														<th style='text-align: center; vertical-align: middle;'>Client
															...
															status</th>
															<!-- <th style='text-align: center; vertical-align: middle;'>Manager
															Round status</th> -->
												...
												<tbody>
													<tr>
														<td><h5 id="Clientstatus" style="white-space: pre-wrap; word-wrap: break-word; height:30px;overflow-y:auto;overflow-x:auto;width:200px;"></h5></td>
														<td><h5 id="BDMstatus" style="white-space: pre-wrap; word-wrap: break-word; height:30px;overflow-y:auto;overflow-x:auto;width:200px;"></h5></td>
														<td><h5 id="sctstatus" style="white-space: pre-wrap; word-wrap: break-word; height:60px;overflow-y:auto;overflow-x:auto;width:400px;"></h5></td>
														<!-- <td><h5 id="managerstatus" style="white-space: pre-wrap; word-wrap: break-word; height:30px;overflow-y:auto;overflow-x:auto;width:200px;"></h5></td> -->
														<td><h5 id="Teamleadstatus" style="white-space: pre-wrap; word-wrap: break-word; height:30px;overflow-y:auto;overflow-x:auto;width:250px;"></h5></td>
													</tr>
												</tbody>
											</table>
											<table class='table table-bordered table-striped'
												...
												<tbody>
													<tr>														
														<td><h5 id="client_cmnt" style="white-space: pre-wrap; word-wrap: break-word; height:30px;overflow-y:auto;overflow-x:auto;width:200px;"></h5></td>
														<td><h5 id="bdm_cmnt" style="white-space: pre-wrap; word-wrap: break-word; height:30px;overflow-y:auto;overflow-x:auto;width:200px;"></h5></td>
														<td><h5 id="sct_cmnt" style="white-space: pre-wrap; word-wrap: break-word; height:60px;overflow-y:auto;overflow-x:auto;width:400px;"></h5></td>
														<!-- <td><h5 id="manager_cmnt" style="white-space: pre-wrap; word-wrap: break-word; height:30px;overflow-y:auto;overflow-x:auto;width:200px;"></h5></td> -->
														<td><h5 id="tl_cmnt" style="white-space: pre-wrap; word-wrap: break-word; height:90px;overflow-y:auto;overflow-x:auto;width:250px;"></h5></td>
							...
							<!-- 	modal for candidate feedback	START -->
									<div class='modal hide fade' id='modal-candidateFeedBack'
										...
										<div class='modal-body' id="canFeedback">
											<form class='form form-horizontal validate-form'
												style='margin-bottom: 0;' action="store_Feedback" method="post">
														...
														<div class='box-content box-no-padding'>
															<div class='responsive-table'>
																<div class='scrollable-area'>
																	...
																	<div class='controls'>
																			<h3><b><span id='candidateidNameFB' style="color:red;"></span>
																			<span id='mobileno' style="color:red;"></span></b></h3>
																			</div>
																	</div>
																	<div class='control-group'>
																		<label class='control-label' >Discussion
																			</label>
																		<div class='controls'>
																			<textarea 
																				data-rule-minlength='2' 
																				data-rule-required='false' id='candidateComment'
																				name='candidateComment' placeholder='Enter comments'
																				required></textarea>
															...
															<div class='responsive-table'>
																<div class='scrollable-area'>
																	<table
																		...
																		<thead>
																			<tr>
																				<th style='text-align: center;'>Caller
																					Name</th>
																					<th style='text-align: center;'>Called Date</th>
																					<th style='text-align: center;'>Candidate FeedBack</th>
...
<!-- 	modal for candidate feedback	End -->
														...
														<div class='box-padding'>
															<form class="form-horizontal" style="margin-bottom: 0;"
																...
																<div class='step-content'>
																		...
																		<div class='span12'>
																			...
																			<input type="hidden" name="candidateid"
																				...
																				<input class='span12' id='jobcode' name='jobCode'
																					...
																					type='hidden' >
																					<input class='span12' id='Bdname_Req' name='Bdname_Req'
																					type='hidden' >
																				
																			<div class='control-group'>
																			<label style="color:red">Job ID:  <span id="jobCode_span" style="color:blue"></span></label>
																				<!-- <label style="color:red">Client:  <span id="clientName_Req_span" style="color:blue"></span></label>
																			<label style="color:red">BdName:  <span id="Bdname_Req_span" style="color:blue"></span></label> 
																			<label>Job ID</label> -->
																				<!-- <div>
																			...
																			<c:choose>
																				<c:when test="${departmentId == 5}">
																					...
																					<div class='control-group'>
																						...
																						<div>
																							<input class='span12' pattern="[A-Za-z]{5}[0-9]{4}[A-Za-z]{1}"
																			...
																			<div class='control-group'>
																				...
																				<div>
																					<input class='span12'
																						 pattern="^([A-Za-z]+ )+[A-Za-z]+$|^[A-Za-z]+$" id='txtFirstName'
																						data-rule-maxlength='25' name='txtFirstName'
																						type='text' placeholder="First name....Only Characters"
																			...
																			<div>
																				<input class='span12' data-rule-email='true'
																					...
																					placeholder="Email ID" onchange="checkEmail()" required>
																		...
																		<div class='control-group'>
																			...
																			<div>
																				<input class='span12' minlength='10' maxlength='13'
																					...
																					data-rule-required='true' onchange="checkContact()" required>
																		...
																		<div class='form-group'>
																			...
																			<div>
																				<input class='span12' 
																					...
																					placeholder='Naitve Location' pattern="^([A-Za-z]+ )+[A-Za-z]+$|^[A-Za-z]+$">
																			</div>
																		</div>
																	...
																	<div class='row'>
																		<div class='span12'>
																			...
																			<div class='control-group'>
																				<label>Primary Skill <span style="color:red">(*)</span></label>
																				<div>
																					<input class='span12'
																						data-rule-maxlength='20' data-rule-required='true'
																			...
																			<div class='control-group'>
																				...
																				<div>
																					<input class='span12'
																						data-rule-maxlength='20' data-rule-required='true'
																						id='secSkill' name='secSkill' type='text'
																			...
																			<div class='control-group'>
																				...
																				<div>
																					<input class='span12'
																						...
																						data-rule-maxlength='20' data-rule-required='true'
																						id='candidatedesg' name='candidatedesg'
																						type='text' placeholder="Candidate Designation"
																			...
																			<div class='control-group'>
																				...
																				<div>
																					<input class='span12' data-rule-minlength='1'
																						...
																						min="1" max="99" id='totalExp' name='totalExp' pattern="^([A-Za-z0-9.]+ )+[A-Za-z0-9.]+$|^[A-Za-z0-9.]+$"
																						type='text' placeholder="Total Experience"
																						required>
																				</div>
																			</div>
																			<div class='control-group'>
																				<label for='revalent'>Relevant Experience
																					<span style="color:red">(*)</span></label>
																				<div>
																					<input class='span12' data-rule-minlength='1'
																						data-rule-maxlength='4' data-rule-required='true'
																			...
																			<div class='control-group'>
																				...
																				<div>
																					<input class='span12'
																						data-rule-required='true' data-rule-maxlength='25'
																						id='currentOrg' name='currentOrg' type='text' pattern="^([A-Za-z]+ )+[A-Za-z]+$|^[A-Za-z]+$"
																	...
																	<div class='control-group'>
																		<label for='curctc'>Current CTC <span style="color:red">(*)</span></label>
																		<div>
																			<input class='span12' data-rule-required='true'
																	...
																	<div class='control-group'>
																		<label for='expctc'>Expected CTC <span style="color:red">(*)</span></label>
																		<div>
																			<input class='span12' data-rule-required='true'
																		...
																		<div class='control-group'>
																			...
																			<div>
																				<input class='span12' data-rule-email='true'
																					...
																					id="emailshow" style="color: green;"></span>
																					<span id="showgreen" style="color: red;"></span>
																				<p class='help-block'></p>
																			</div>
																		</div>
																...
																<div id="npn_r" style="display: none">
																	...
																	<div class="control-group">
																		<input class='span12' id="npn_reason" type="text"
																			pattern="^([A-Za-z]+ )+[A-Za-z]+$|^[A-Za-z]+$" placeholder="Reason"
																			name="npn_reason" >
																	</div>
																	</div>
																<div class='control-group'>
																...
																<div class='control-group'>
																	...
																	<div>
																		<select data-rule-required='true' class='span12' onchange="checkperm()"
																...
																<div id="iscontract" style="display: none">
																	<label for="Cname">Payroll Company Name <span style="color:red">(*)</span></label>
																	<div class="control-group">
																		<input class='span12' id="curcompname" type="text" pattern="^([A-Za-z]+ )+[A-Za-z]+$|^[A-Za-z]+$"
																			placeholder="Company Name" name="curcompname" required>
																	</div>
																	<label for="Duration">Duration(in Year & Months)<span
																				style="color: red">(*)</span></label>
																	<div class="control-group">
																...
																<div class='control-group'>
																	<label for='prvious_comp_name'>Previous organization/client name<span
																				style="color: red">(*)</span></label>
																	<div>
																		<select data-rule-required='true' class='span12' id='prvcname' onchange="checkPvsCmpny()" name='prvcname' required>
																			<option value="">Select</option>
																			<option value="YES">YES</option>
																			<option value="NO">NO</option>
																		</select>
																...
																<div class='control-group'>
																	<label for='date'>Relieved Date  <span style="color:red">(*)</span></label>																	
																...
																<div class='control-group'>
																	<label for='any_inerview'>Any interviews are in
																		pipeline<span style="color: red">(*)</span></label>
																	<div>
																...
																<div id="anyInterviewpipeline" style="display: none">
																	...
																	<div class="control-group">
																		<input class='span12' id="com_name" type="text"
																			pattern="^([A-Za-z0-9]+ )+[A-Za-z0-9]+$|^[A-Za-z0-9]+$" placeholder="company Name" placeholder="company Name"  
																			name="com_name">
																	</div>
																	</div>
															...
															<div class='control-group'>
																...
																<div id="spwork" style="display: none">
															       <label for="spwork">Spouse does Job<span	style="color: red">(*)</span></label>
																	 <div class="control-group">
																	...
																	<label for="kids">Have Kids<span style="color: red">(*)</span></label>
																	<div class="control-group">
																	...
																	<div class='control-group'>
																		<label for='file'>Resume Upload<span style="color:red">(*)</span></label>
																		<div>
																	...
																	<!-- <div class='form-group'>
																	<label for='file'>Upload Other Documents<span
																		style="color: red"></span></label>
																	<div>
																		<input name="ofile" data-rule-required='false'
																			id='ofile' type="file"  onchange="ValidateSize(this)" 
																			/> 
																			<span id ='filename2'></span>
																	</div>
																</div> -->
																
																	<input class="btn btn-success btn-xs" style="background:#0b3c7c" type="submit" id="updateid"
																										...
																										<div class='scrollable-area'>
																											<div class="pagination" style='font-size:20px;'>
																												<table
																													...
																													data-pagination-records='10'
																													data-pagination-top-bottom='true'
																													style='margin-bottom: 0;font-size:20px;' id="sampletable1">
																													<thead>
																														<tr>
																															<th
													...
													<table>
														...
														<tr>
															<td style="color: purple">Family background (About
																spouse work (Y/N) location and <br>kids information).<br><font color=red> Some
														...
														<!-- <tr>
															<td style="color: purple">Comments: (Manager/TL)</td>
															<td>NA</td>
														</tr>
 -->
													...
													<!-- <table>
														...
														<tr>
															<td style="color: purple">PAN No</td>
															<td id='cPAN'></td>

														</tr>
														<tr>
															<td style="color: purple">DOB</td>
															<td id='cDOB'></td>

														</tr>

														<tr>
															<td style="color: purple">Skype ID</td>

															<td id='cskypeid'></td>
														</tr>
														<tr>
															<td style="color: purple">Min Time Required to Join
															</td>

															<td id='minreqjoin'></td>
														</tr>
														<tr>
															<td style="color: purple">Working With</td>
															<td id='cCurOrg'></td>
														</tr>
														<tr>
															<td style="color: purple">Reason Notice Period</td>

															<td id='desc_np_negotion'></td>
														</tr>


														<tr>
															<td style="color: purple">Company Name</td>
						...
						<center>
							<button 
								class="btn btn-success btn-xs" style="background:#0b3c7c" onclick="goBack()">Cancel</button>
						</center>
						<br>
						<center><a href="recruiter_exportSourcedData?jobId=${jobId}&action=recruiter" class="btn btn-success btn-xs" style="background:#0b3c7c" >Export to Excel</a>
</center>
...
<script type="text/javascript">
                                      function editProfile(candidateid,jobid,jobcode,sourcedby,clientname,Bdname){ 
                                    	 // alert(jobid);
                                       //   alert(jobcode);  
                                         $.ajax({
                                                type: "POST",
                                                ...
                                                success: function(response){
                                                	...
                                                	$('#Bdname_Req').val(Bdname);
                                            	 $('#jobDescId').val(jobid);
                                                 $('#jobcode').val(jobcode);
                                                 $('#jobCode_span').text(jobcode);
                                                 $('#candidateid').val(candidateid);
                                                  ...
                                                  if(response.candidateAttachements!=null){
...
<script type="text/javascript">
                                             function doActionstatus(candidateid,name,jobid){
                                                 $.ajax({
                                                        type: "get",
...
<script>
  function candidateDetails(candidateid,basic_qualification,highest_qualification,
			...
			mgrofficialId,intrstlevlworkLoc,comskillsRatig,professional_Refrnces,idProofDetails)
	{
	  ...
	  $('#cidProofDetails').val(idProofDetails);
	  $('#cprofessional_Refrnces').val(professional_Refrnces);
	  $('#ccomskillsRatig').val(comskillsRatig);
	  $('#cintrstlevlworkLoc').val(intrstlevlworkLoc);
  }
...
<script type="text/javascript">
 function sendMailToCandidate(canid,jobid){
	
	
	if (confirm("Are you sure send mail to candidate??")) {
	    $.ajax({
	    	type : "POST",
	        asyn : false,
	        url  : "sendMailToCandidate?canid="+canid+"&jobid="+jobid,
	        success  : function(response){
...
<script type="text/javascript">
    function uploadFile(candidateid,jobid,jobcode,cmpny){
