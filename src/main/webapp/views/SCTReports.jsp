...
<html>
		...
		<section id='content'>
			<div class='container-fluid'>
				<div class='row-fluid' id='content-wrapper' style="margin-top:-180px;">
					...
					<div class='title' style="line:width:50px;">
						...
						<Strong style="color:#000080;font-size:25px;">SCT Report</Strong>
					</div>
								...
								<div class='box-content'>
									<form class='form form-horizontal validate-form'
										action="sctReportBySearch" method="Get" style='margin-bottom: 0;' enctype="multipart/form-data">
			...
			<div class='box-content box-no-padding'>
							...
							<center>
						<a href="exportClientReport?fromDate=${fromDate}&toDate=${toDate}"
							class="btn btn-success btn-xs">Export to Excel</a>
					</center>
							</div>
							</div>
							</div>
